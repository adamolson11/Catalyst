  ...
  return (
    <div className="max-w-md mx-auto shadow-md rounded-md overflow-hidden">
      <div className="px-6 py-8">
        {/* <h2 className="text-2xl font-semibold text-gray-800 mb-4 text-white">Sign Up</h2> */}
        <form onSubmit={handleSignup}>
          <div className="mb-4">
            <label htmlFor="email" className="block text-gray-700 text-white">Email Address</label>
          ...
          <div className="mb-4">
            <label htmlFor="password" className="block text-gray-700 text-white">Password</label>
          ...
          <div className="mb-4">
            <label htmlFor="confirmPassword" className="block text-gray-700 text-white">Confirm Password</label>
          ...
          <button type="submit" className="w-full bg-green-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors duration-300">Sign Up</button>
        </form>
      </div>
    </div>
  );
